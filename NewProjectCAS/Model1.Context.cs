...
namespace NewProjectCAS
{
    ...
    public partial class Project2Entities : DbContext
    {
        ...
        internal void UpdateSupplier(string firstName, string lastName, string companyName, string companyAddress, int mid)
        {
        ...
        public virtual int InsertPatient(string firstName, string lastName, Nullable<System.DateTime> dateOfBirth, string gender, string address, Nullable<int> memberId)
        {
            var firstNameParameter = firstName != null ?
                new ObjectParameter("FirstName", firstName) :
                new ObjectParameter("FirstName", typeof(string));
        ...
        public virtual int UpdatePatient(Nullable<int> memberId, string firstName, string lastName, Nullable<System.DateTime> dateOfBirth, string gender, string address)
        {
            var memberIdParameter = memberId.HasValue ?
                new ObjectParameter("MemberId", memberId) :
                new ObjectParameter("MemberId", typeof(int));
